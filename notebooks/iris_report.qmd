...
![Pairplot of Features vs Target](../figures/pairplot.png){#fig-pplot width=95%}

![Heatmap of Correlation (1.0 = High +ve Correlation, 0 = No Correlation)](../figures/corr.png){#fig-corr width=70%}

![Histogram of Classes vs Petal Width](../figures/histplot.png){#fig-hist width=70%}
