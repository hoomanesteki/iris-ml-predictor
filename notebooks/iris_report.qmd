...
We see a strong correaltion between petal length and sepal length in @fig-corr. As well, there is a strong correlation between `PetalWidthCm` and `PetalLengthCm`. This implies that the wider a petal is, the longer it also could be.
