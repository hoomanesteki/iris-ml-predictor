...
### Examples of unacceptable behavior by participants include:
    ...
    For a data science project: Any attempt to misuse the data or code for malicious purposes, or any public mockery or demeaning of the model's performance/design.

## Our Responsibilities

The project maintainers are responsible for clarifying the standards of acceptable behaviour and are expected to take apprpriate and fair corrective action in response to any instances of unacceptable behavior.

Project maintainers reserve the right to remove, edit, or reject and comments, commits, code, or issues that are deemed to not align with this Code of Conduct, and to ban temporarily or permanently, any community member for behaviors deemed inappropriate threatening, offensive, or harmful.
...
If you experience or witness unacceptable behavior, or have any other concerns, please report it to the project maintainer(s) immediately by reaching out to us on Github.
...
Sections of this Code of Conduct were adapted from the breast-cancer-predictor Code of Conduct, which can be found at https://github.com/ttimbers/breast-cancer-predictor/blob/0.0.1/CODE_OF_CONDUCT.md

#### Assist provided by Google Gemini